    ...
    return (
        <article className={styles.post}>
            ...
            <div className={styles.commentList}>
                {comments.map(commentFromMap => {
                    return <Comment key={commentFromMap} content={commentFromMap} onDeleteComment={() => deleteComment(commentFromMap)} /* passando a função como propriedade */ />
                })}
            </div>
        </article>
    )
